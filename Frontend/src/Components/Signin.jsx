  ...
  return (
    <FadeInWrapper>
      <div className="relative flex items-center justify-center min-h-screen p-4 overflow-hidden bg-gradient-to-br from-orange-50 via-white to-orange-100">
        ...
        {/* Form container */}
        <div className="relative z-10 backdrop-filter backdrop-blur-sm bg-white/80 rounded-2xl shadow-2xl border border-orange-200/50 max-w-md w-full p-8 transition-all duration-500 hover:shadow-orange-200/50 hover:shadow-3xl">
