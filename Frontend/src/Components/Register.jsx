  ...
  return (
    <FadeInWrapper>
      <div className="relative flex items-center justify-center min-h-screen p-4 overflow-hidden bg-gradient-to-br from-orange-200 via-orange-100 to-orange-200">
        ...
        {/* Form Container */}
        <div className="relative z-10 w-full max-w-lg backdrop-filter backdrop-blur-sm bg-white/85 rounded-2xl shadow-2xl border border-orange-200/50 p-8 transition-all duration-500 hover:shadow-orange-200/50 hover:shadow-3xl">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-3 pl-11 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-800 transition-all duration-300 hover:border-orange-300 appearance-none"
                >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pl-11 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-800 transition-all duration-300 hover:border-orange-300"
                />
                <svg className="absolute left-3 top-3.5 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
