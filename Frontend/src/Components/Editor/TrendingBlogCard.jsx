...
function TrendingBlogcard({ content, author, index }) {
    ...
    return (
        <div 
            ...
            className='group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 border border-orange-100 overflow-hidden cursor-pointer'
        >
            {/* Trending Badge */}
