...
function Blogcard({ content, author }) {
    ...
    return (
        <div 
            ...
            className='group cursor-pointer bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-orange-100 overflow-hidden'
        >
            {/* Banner Image */}
