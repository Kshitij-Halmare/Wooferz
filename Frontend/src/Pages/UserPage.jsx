      ...
      <div className="p-6 md:p-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-orange-100 hover:shadow-2xl transition-shadow duration-300">
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="w-full text-center lg:text-left">
              <h1 className="text-4xl font-bold mb-3 text-gray-800 bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">
                {user.name}
              </h1>
              {user.occupation && (
              ...
              {user.address && (
                <div className="flex items-center justify-center lg:justify-start gap-3 bg-orange-50 px-4 py-2 rounded-full inline-flex">
          ...
          {user.dogsForAdoption.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {user.dogsForAdoption.map(dog => (
                <div key={dog._id} className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-orange-100">
        ...
        <div className="mb-12">
          ...
          {user.blogs.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {user.blogs.map(blog => (
                <div key={blog._id} className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-orange-100">
        ...
        {openDeleteDialog && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full border border-orange-100">
