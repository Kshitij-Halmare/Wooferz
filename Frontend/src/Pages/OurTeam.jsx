...
function OurTeam() {
  ...
  const scrollY = useScrollPosition();
    ...
    //     }
        ...
        return (
            <div
                className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 cursor-pointer transform hover:scale-105 hover:-translate-y-2 border border-orange-100 w-72 h-48"
                onMouseEnter={onHover}
            >
                <div className="flex flex-col items-center text-center space-y-3 h-full">
                    <div className="relative">
                        <div className="w-16 h-16 rounded-full overflow-hidden border-3 border-orange-200 shadow-lg">
                            <img
                                src={testimonial.photo}
                                alt={testimonial.name}
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50">
            ...
            <div className="relative overflow-hidden">
                <div
                    className="absolute inset-0 bg-gradient-to-br from-orange-600 via-red-600 to-pink-600"
            ...
            <div className="relative max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="grid lg:grid-cols-3 gap-10">
                    {teamMembers.map((member, index) => (
                        ...
                        >
                            {/* Card */}
                            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-700 overflow-hidden border border-orange-100">
          ...
          />
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                        {[
                            ...
                            <div key={index} className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-orange-100 group hover:scale-105">
