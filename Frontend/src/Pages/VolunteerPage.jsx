            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="group">
                    ...
                    <input
                        ...
                        className="w-full px-6 py-4 border-2 border-gray-200 rounded-xl focus:ring-orange-500 focus:border-orange-500 transition-all"
                ...
                <div className="group">
                    ...
                    <textarea
                        ...
                        onChange={handleInputChange}
                        rows={3}
                        className="w-full px-6 py-4 border-2 border-gray-200 rounded-xl focus:ring-orange-500 focus:border-orange-500 transition-all resize-none"
                ...
                <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-orange-600 to-amber-600 text-white py-5 px-8 rounded-xl hover:from-orange-700 hover:to-amber-700 transition duration-300 font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105"
                >
                    Submit Application
                </button>
            </form>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                        <div className="md:col-span-2">
                            ...
                            <div className="flex space-x-4">
                                <a href="#" className="w-12 h-12 bg-orange-800 rounded-full flex items-center justify-center hover:bg-orange-700 transition-colors">
